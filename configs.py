...
class Config(object):
    API_ID = int(os.getenv("API_ID", "18358648"))
    API_HASH = os.getenv("API_HASH", "dd6e687404a03cde81c1566db08e1e7e")
    BOT_TOKEN = os.getenv("BOT_TOKEN", "5869552833:AAEU22u99-iPBXLw-3VsUn07akBr3PnYlws")
    BOT_SESSION_NAME = os.getenv("BOT_SESSION_NAME", "abhishemmodder")
...
#   Channel id where your posts are stored.
    CHANNEL_ID = int(os.getenv("CHANNEL_ID", "-1001664870308") 
    BOT_USERNAME = os.getenv("BOT_USERNAME", "Moviez_Searching_filter_Bot")
    BOT_OWNER = int(os.getenv("BOT_OWNER", "5281556405"))
#   OWNER_USERNAME = os.getenv("OWNER_USERNAME", "@BADGUJERA")
...
ꜰᴏʀ ᴍᴏʀᴇ ɪɴꜰᴏ ᴄʟɪᴄᴋ ᴏɴ ʜᴇʟᴘ ✅""" )
    UPDATES_CHANNEL = os.getenv("UPDATES_CHANNEL", "-1001546987921")
    DATABASE_URL = os.getenv("DATABASE_URL", "mongosh "mongodb+srv://cluster0.hba8dye.mongodb.net/myFirstDatabase" --apiVersion 1 --username Abhishek")
    LOG_CHANNEL = int(os.getenv("LOG_CHANNEL", "-1001889197505"))
    ...
    MDISK_API = os.getenv("MDISK_API", "1njabKIDs67zgcE7dooj)
...
👉 <a href='https://t.me/devilmodder007'>devilmodder007</a>
